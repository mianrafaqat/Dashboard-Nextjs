...
export const gridOrderImage = ({ img }) => (
  <div>
    <img className="rounded-xl h-20 md:ml-3" src={img} alt="order-item" />
  </div>
);
...
export const customersGrid = [
      ...
      return (
        <div className="image flex gap-4">
          <img
            className="rounded-full w-10 h-10"
            src={
              cellValues.value?.src ? cellValues.value?.src : cellValues.value
            }
            alt="customers"
          />
        </div>
  ...
  },
  {
    ...
    renderCell: (cellValues) => {
      return (
        <div className="flex gap-2 justify-center items-center text-gray-700 capitalize text-center">
        <p
          style={{ background: cellValues?.row.StatusBg }}
          className="rounded-full h-3 w-3"
        />
        <p>{cellValues?.row.Status}</p>
      </div>
      );
    },  
...
export const employeesGrid = [
  ...
  { field: "Name", headerText: "Name", textAlign: "Center", width: 150 },
  {
    field: "Title",
...
export const links = [
  ...
  },
  {
    ...
    Links: [
      ...
      {
        name: "financial",
        url: "Charts/financial",
        icon: <RiStockLine />,
      },
      {
        name: "color-mapping",
        url: "Charts/color-mapping",
        icon: <BsBarChart />,
      },
      {
        name: "pyramid",
    ...
    renderCell: (cellValues) => {
      return (
        <button
          type="button"
          style={{
            background: cellValues.row.StatusBg,
            padding: "3px",
            width: "70px",
          }}
          className="text-white py-1 px-2 capitalize rounded-2xl text-md"
